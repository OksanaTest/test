package com.goit.finalProject.projectCode.model.aircraftsForSikorskyFactory;
...
/*
fields initialization with values from .json file with initial parameters for Sikorsky S - 52
 */
    static {
        ...
        try {
            ...
            System.err.println("[ERROR]: SOME INITIAL VALUES FOR Sikorsky S - 52 CAN NOT BE READ FROM FILE");
            StackTraceElement[] stackTraceElements = Thread.currentThread().getStackTrace();
            for(StackTraceElement element: stackTraceElements){
                System.err.println(element);}
        } catch (ClassCastException e) {System.err.println("[ERROR]:WRONG InitialValues FILE STRUCTURE");
        }catch (ParseException e){ System.err.println("[ERROR]: ERROR IN THE InitialValues file FOR SIKORSKY S - 52");
        }catch (IOException e){
